...
def main(argv=None) -> int:
    ...
    analyze.add_argument("--batch-size", type=int, default=12)
    analyze.add_argument("--concurrency", type=int, default=48)
    analyze.add_argument("--requests-per-minute", type=int, default=480)
